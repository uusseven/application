  ...
  <section class="vbox">
    <header class="bg-white header header-md navbar navbar-fixed-top-xs box-shadow">
      <div class="navbar-header aside-md dk">
        ...
        <a href="<?= base_url(); ?>assets/student/indexHome" class="navbar-brand">
      ...
      <ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user user">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu animated fadeInRight m-t-xs">
            ...
            <li>
              <a href="<?= base_url(); ?>assets/student/Profil">Profil</a>
            </li>
            <li>
              <a href="#">
            ...
            <li class="divider"></li>
            <li>
              <a href="<?= base_url(); ?>assets/student/index" data-toggle="ajaxModal" >Keluar</a>
            </li>
          </ul>
    </header>
    <section>
                  ...
                  <ul class="nav nav-main" data-ride="collapse">
                    <li  class="active">
                      ...
                      <ul class="nav dk">
                        ...
                        <li >
                          <a href="<?php echo base_url('index.php/student/gantipassword'); ?>" class="auto">
                            <i class="i i-dot"></i>
                ...
                <section class="scrollable">
                  ...
                  <ul class="list-group no-bg no-borders auto">
                    <li class="list-group-item">
                      <div class="media">
                        <span class="pull-left thumb-sm avatar">
                          <img src="assets/student/images/a3.png" alt="..." class="img-circle">
                    ...
                    <li class="list-group-item">
                      <div class="media">
                        <span class="pull-left thumb-sm avatar">
                          <img src="assets/student/images/a1.png" alt="...">
