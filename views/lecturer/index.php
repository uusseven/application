                ...
                <section class="scrollable padder">
                  <section class="row m-b-md">
                    <div class="col-sm-6">
                      ...
                      <small>Welcome back, Pak Dosen, <i class="fa fa-map-marker fa-lg text-primary"></i> Bandung</small>
                    </div>
                ...
                <section class="scrollable">
                  ...
                  <ul class="list-group no-bg no-borders auto">
                    <li class="list-group-item">
                      <div class="media">
                        <span class="pull-left thumb-sm avatar">
                          <img src="<?= base_url(); ?>assets/lecturer/images/a3.png" alt="..." class="img-circle">
                    ...
                    <li class="list-group-item">
                      <div class="media">
                        <span class="pull-left thumb-sm avatar">
                          <img src="<?= base_url(); ?>assets/lecturer/images/a2.png" alt="...">
                          <i class="on b-black bottom"></i>
                        </span>
                        <div class="media-body">
                    ...
                    <li class="list-group-item">
                      <div class="media">
                        <span class="pull-left thumb-sm avatar">
                          <img src="<?= base_url(); ?>assets/lecturer/images/a1.png" alt="...">
