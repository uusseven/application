                                ...
                                <div class="inline">
                                  <div class="easypiechart" data-percent="75" data-line-width="6" data-bar-color="#fff" data-track-Color="#2796de" data-scale-Color="false" data-size="140" data-line-cap='butt' data-animate="1000">
                                    <div class="thumb-lg avatar">
                                      <img src="<?= base_url(); ?>assets/lecturer/images/a5.png" class="dker">
                                    </div>
                                  </div>
                                  <div class="h4 m-t m-b-xs font-bold text-lt">Pak Dosen</div>
                            ...
                            <div class="wrapper m-t-xl m-b">
                              <div class="row m-b">
                                <div class="col-xs-6 text-right">
                                  <small>NIP</small>
                                  <div class="text-lt font-bold">4400313011</div>
                                </div>
                                <div class="col-xs-6">
                                  <small>Jurusan</small>
                              ...
                              <div class="row">
                                <div class="col-xs-6 text-right">
                                  <small>Status Dosen</small>
                                  <div class="text-lt font-bold">Dosen Tetap</div>
                                </div>
                                <div class="col-xs-6">
                                  <small>Tahun Masuk</small>
                                  <div class="text-lt font-bold">2007</div>
                                </div>
                                <div class="form-group">
<a  href="<?php echo base_url('index.php/lecturer/eror'); ?>" class="auto">
