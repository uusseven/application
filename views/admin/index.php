...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url(); ?>assets/admin/js/calendar/bootstrap_calendar.css" type="text/css" />
  <!--[if lt IE 9]>
...
<body class="">
    ...
    <header class="bg-white header header-md navbar navbar-fixed-top-xs box-shadow">
      <div class="navbar-header aside-md dk">
        ...
        <a href="<?php echo base_url('index.php/admin/indexHome'); ?>" class="navbar-brand">
          <img src="<?= base_url(); ?>assets/admin/images/rsz_li.png" class="m-r-sm" alt="scale">
                ...
                <section class="scrollable padder">
                  <section class="row m-b-md">
                    <div class="col-sm-6">
                      ...
                      <small>Welcome back, Mr. Admin, <i class="fa fa-map-marker fa-lg text-primary"></i> Bandung</small>
                    </div>
                ...
                <section class="scrollable">
                  ...
                  <ul class="list-group no-bg no-borders auto">
                    <li class="list-group-item">
                      <div class="media">
                        <span class="pull-left thumb-sm avatar">
                          <img src="<?= base_url(); ?>assets/admin/images/a3.png" alt="..." class="img-circle">
                    ...
                    <li class="list-group-item">
                      <div class="media">
                        <span class="pull-left thumb-sm avatar">
                          <img src="<?= base_url(); ?>assets/admin/images/a2.png" alt="...">
                          <i class="on b-black bottom"></i>
                        </span>
                        <div class="media-body">
                    ...
                    <li class="list-group-item">
                      <div class="media">
                        <span class="pull-left thumb-sm avatar">
                          <img src="<?= base_url(); ?>assets/admin/images/a1.png" alt="...">
  ...
  <script src="<?= base_url(); ?>assets/admin/js/slimscroll/jquery.slimscroll.min.js"></script>
    <script src="<?= base_url(); ?>assets/admin/js/charts/easypiechart/jquery.easy-pie-chart.js"></script>
  <script src="<?= base_url(); ?>assets/admin/js/charts/sparkline/jquery.sparkline.min.js"></script>
  <script src="<?= base_url(); ?>assets/admin/js/charts/flot/jquery.flot.min.js"></script>
  <script src="<?= base_url(); ?>assets/admin/js/charts/flot/jquery.flot.tooltip.min.js"></script>
  <script src="<?= base_url(); ?>assets/admin/js/charts/flot/jquery.flot.spline.js"></script>
  <script src="<?= base_url(); ?>assets/admin/js/charts/flot/jquery.flot.pie.min.js"></script>
  <script src="<?= base_url(); ?>assets/admin/js/charts/flot/jquery.flot.resize.js"></script>
  <script src="<?= base_url(); ?>assets/admin/js/charts/flot/jquery.flot.grow.js"></script>
  <script src="<?= base_url(); ?>assets/admin/js/charts/flot/demo.js"></script>

  <script src="<?= base_url(); ?>assets/admin/js/calendar/bootstrap_calendar.js"></script>
  <script src="<?= base_url(); ?>assets/admin/js/calendar/demo.js"></script>

  <script src="<?= base_url(); ?>assets/admin/js/sortable/jquery.sortable.js"></script>
